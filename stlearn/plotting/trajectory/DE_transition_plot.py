...
def DE_transition_plot(adata,top_genes=10):
    ...
    pos_2 = adata.uns[trajectories[1]].set_index("gene").loc[adata.uns["compare_result"]["pos_2"][:top_genes]].iloc[::-1]
    neg_1 = adata.uns[trajectories[0]].set_index("gene").loc[adata.uns["compare_result"]["neg_1"][:top_genes]].iloc[::-1]
    neg_2 = adata.uns[trajectories[1]].set_index("gene").loc[adata.uns["compare_result"]["neg_2"][:top_genes]].iloc[::-1]

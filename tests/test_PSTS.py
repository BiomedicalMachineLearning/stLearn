...
class TestPSTS(unittest.TestCase):
    ...
    def test_PSTS(self):
        ...
        st.spatial.trajectory.pseudotimespace_global(adata,use_label="leiden",list_cluster=[0,1])
        st.spatial.trajectory.detect_transition_markers_clades(adata,clade=1,use_raw_count=False,cutoff_spearman=0.3)
